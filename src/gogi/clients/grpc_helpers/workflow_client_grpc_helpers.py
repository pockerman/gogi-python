...
class WorkflowClientGRPCHelper:
    ...
    @staticmethod
    def build_grpc_register_workflow_request(request: RegisterWorkflowRequest) -> workflow_service_pb2.RegisterWorkflowRequest:
        return workflow_service_pb2.RegisterWorkflowRequest(
            spec=WorkflowClientGRPCHelper.build_grpc_workflow_spec(request.spec),
        )

    @staticmethod
    def serialize_register_workflow_grpc_response(grpc_response: workflow_service_pb2.RegisterWorkflowResponse) -> RegisterWorkflowResponse:
    ...
    @staticmethod
    def serialize_get_workflow_grpc_response(grpc_response: workflow_service_pb2.GetWorkflowResponse) -> GetWorkflowResponse:
    ...
    @staticmethod
    def serialize_list_workflows_grpc_response(grpc_response: workflow_service_pb2.ListWorkflowsResponse) -> ListWorkflowsResponse:
    ...
    @staticmethod
    def build_grpc_update_workflow_request(request: UpdateWorkflowRequest) -> workflow_service_pb2.UpdateWorkflowRequest:
        return workflow_service_pb2.UpdateWorkflowRequest(
            spec=WorkflowClientGRPCHelper.build_grpc_workflow_spec(request.spec),
        )

    @staticmethod
    def serialize_update_workflow_grpc_response(grpc_response: workflow_service_pb2.UpdateWorkflowResponse) -> UpdateWorkflowResponse:
        return UpdateWorkflowResponse(version=grpc_response.version)

    # --- DeleteWorkflow ---

    @staticmethod
    def build_grpc_delete_workflow_request(request: DeleteWorkflowRequest) -> workflow_service_pb2.DeleteWorkflowRequest:
        return workflow_service_pb2.DeleteWorkflowRequest(name=request.name)

    @staticmethod
    def serialize_delete_workflow_grpc_response(grpc_response: workflow_service_pb2.DeleteWorkflowResponse) -> DeleteWorkflowResponse:
        return DeleteWorkflowResponse(success=grpc_response.success)

    # --- DeployWorkflow ---

    @staticmethod
    def build_grpc_deploy_workflow_request(request: DeployWorkflowRequest) -> workflow_service_pb2.DeployWorkflowRequest:
    ...
    @staticmethod
    def serialize_deploy_workflow_grpc_response(grpc_response: workflow_service_pb2.DeployWorkflowResponse) -> DeployWorkflowResponse:
    ...
    @staticmethod
    def build_grpc_get_deployment_status_request(request: GetDeploymentStatusRequest) -> workflow_service_pb2.GetDeploymentStatusRequest:
        return workflow_service_pb2.GetDeploymentStatusRequest(workflow_id=request.workflow_id)

    @staticmethod
    def serialize_get_deployment_status_grpc_response(grpc_response: workflow_service_pb2.GetDeploymentStatusResponse) -> GetDeploymentStatusResponse:
    ...
    @staticmethod
    def build_grpc_rollback_workflow_request(request: RollbackWorkflowRequest) -> workflow_service_pb2.RollbackWorkflowRequest:
    ...
    @staticmethod
    def serialize_rollback_workflow_grpc_response(grpc_response: workflow_service_pb2.RollbackWorkflowResponse) -> RollbackWorkflowResponse:
    ...
    @staticmethod
    def serialize_register_route_grpc_response(grpc_response: workflow_service_pb2.RegisterRouteResponse) -> RegisterRouteResponse:
    ...
    @staticmethod
    def serialize_list_routes_grpc_response(grpc_response: workflow_service_pb2.ListRoutesResponse) -> ListRoutesResponse:
    ...
    @staticmethod
    def serialize_get_job_status_grpc_response(grpc_response: workflow_service_pb2.GetJobStatusResponse) -> GetJobStatusResponse:
    ...
    @staticmethod
    def build_grpc_update_job_progress_request(request: UpdateJobProgressRequest) -> workflow_service_pb2.UpdateJobProgressRequest:
    ...
    @staticmethod
    def serialize_update_job_progress_grpc_response(grpc_response: workflow_service_pb2.UpdateJobProgressResponse) -> UpdateJobProgressResponse:
        return UpdateJobProgressResponse(success=grpc_response.success)

    # --- SaveJobCheckpoint ---

    @staticmethod
    def build_grpc_save_job_checkpoint_request(request: SaveJobCheckpointRequest) -> workflow_service_pb2.SaveJobCheckpointRequest:
    ...
    @staticmethod
    def serialize_save_job_checkpoint_grpc_response(grpc_response: workflow_service_pb2.SaveJobCheckpointResponse) -> SaveJobCheckpointResponse:
    ...
    @staticmethod
    def serialize_complete_job_grpc_response(grpc_response: workflow_service_pb2.CompleteJobResponse) -> CompleteJobResponse:
