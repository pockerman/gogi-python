...
class GuardrailsClientGRPCHelper:
    ...
    @staticmethod
    def build_grpc_validate_input_request(request: ValidateInputRequest) -> llm_quardrail_service_pb2.ValidateInputRequest:
    ...
    @staticmethod
    def serialize_validate_input_grpc_response(grpc_response: llm_quardrail_service_pb2.ValidateInputResponse) -> ValidateInputResponse:
    ...
    @staticmethod
    def serialize_filter_output_grpc_response(grpc_response: llm_quardrail_service_pb2.FilterOutputResponse) -> FilterOutputResponse:
    ...
    @staticmethod
    def serialize_check_policy_grpc_response(grpc_response: llm_quardrail_service_pb2.CheckPolicyResponse) -> CheckPolicyResponse:
    ...
    @staticmethod
    def build_grpc_report_violation_request(request: ReportViolationRequest) -> llm_quardrail_service_pb2.ReportViolationRequest:
    ...
    @staticmethod
    def serialize_report_violation_grpc_response(grpc_response: llm_quardrail_service_pb2.ReportViolationResponse) -> ReportViolationResponse:
